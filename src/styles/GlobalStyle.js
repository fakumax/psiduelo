    ...
    box-sizing: border-box;
		...
		letter-spacing: ${({ theme }) => theme.typography.letterSpacing};
				h1 {
					...
					font-weight: ${(props) => props?.theme?.typography?.h1?.desktop?.fontWeight || '700'};
					...
					@media(max-width: ${(props) => props?.theme?.breakpoints?.md || '960px'}){
						...
						font-weight: ${(props) => props?.theme?.typography?.h1?.mobile?.fontWeight || '700'};
				...
				h2 {
					...
					font-weight: ${(props) => props?.theme?.typography?.h2?.desktop?.fontWeight || '700'};
					...
					@media(max-width: ${(props) => props?.theme?.breakpoints?.md || '960px'}){
						...
						font-weight: ${(props) => props?.theme?.typography?.h2?.mobile?.fontWeight || '700'};
